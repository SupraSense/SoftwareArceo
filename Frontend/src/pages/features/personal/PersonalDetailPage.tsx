...
export const StaffDetail = () => {
    ...
    const antiquityMonths = personal ? Math.floor((new Date().getTime() - new Date(personal.fecha_ingreso).getTime()) / (1000 * 60 * 60 * 24 * 30)) : 0;
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
                    {id === 'new' ? 'Nuevo Personal' : (isEditing ? 'Editar Personal' : 'Detalle de Personal')}
                </h1>
            </div>

            {/* Main Content */}
            <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 ${isEditing ? 'p-0' : 'p-6'} transition-colors`}>
                {isEditing ? (
                    <div className="p-6">
                        <PersonalForm
